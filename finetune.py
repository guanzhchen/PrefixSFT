...
class FlatArguments:
    ...
    prefix_layer_list: Optional[list[str]] = field(
        default=None, metadata={"help": "A list of layers to apply non-causal attention"}
    )
...
def main(args: FlatArguments):
    ...
    if args.model_name_or_path:
        if args.use_qlora:
            ...
            config.update(
                {
                    "prefix_layer_list": args.prefix_layer_list,
                }
            )
